...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: community.image ? [{ url: community.image }] : [],
    },
  };
}
  ...
  return (
    <div className="min-h-screen bg-white pt-[72px]">
      ...
      <div className="relative h-[350px] lg:h-[450px]">
        <Image
          src={community.image || "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1200&q=80"}
          alt={community.name}
          fill
              ...
              <div className="mb-10">
                ...
                <div className="flex flex-wrap gap-3">
                  {community.property_types.map((t) => (
                    <span key={t} className="px-5 py-2.5 bg-navy-800 text-white text-sm rounded-lg font-medium">
                      {t}
                    </span>
                  ))}
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-navy-900 rounded-xl p-6 text-white">
              ...
              <p className="text-white/60 text-sm mb-5">
                Our experts can help you find the perfect property in this community.
              </p>
              <Link
                href="/properties"
                className="flex items-center justify-center gap-2 w-full py-3 bg-gold text-navy-900 font-semibold rounded-lg hover:bg-amber-500 transition-colors mb-3"
              >
                Browse Properties <ArrowLeft className="w-4 h-4 rotate-180" />
              </Link>
              <a
                href="tel:+971563867270"
                className="flex items-center justify-center gap-2 w-full py-3 border border-white/20 text-white rounded-lg hover:bg-white/10 transition-colors text-sm"
              >
            ...
            <div className="bg-white border border-gray-100 rounded-xl p-6">
              ...
              <p className="text-gray-500 text-sm mb-4">
                Our experts know {community.name} inside out and can find you the best deals.
              </p>
              ...
              <a
                href="tel:+971563867270"
                className="flex items-center justify-center gap-2 w-full py-3 bg-navy-800 text-white rounded-lg hover:bg-navy-700 transition-colors mb-3 text-sm font-medium"
              >
                <Phone className="w-4 h-4" /> Call Now
              </a>
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm font-medium"
              >
